 ...
 .pesan{
  ...
  include ("dbconf.php");
    if (isset($_POST['simpan'])) {
		// print_r ($_POST) ;
		$_SESSION['pesan'] = 'Peminjaman Tersimpan! <a href="?page=datapinjam" class="alert-link">KLIK DISINI</a> untuk cek data peminjaman';
	 $sql="INSERT INTO peminjaman (id, nama, nim, tipe, prodi, nohp, tglpin, tglkem, almting, almasal, barang1, barang2, barang3, barang4, barang5) VALUES ('', '$_POST[tnama]', '$_POST[tinduk]', '$_POST[initipe]', '$_POST[tprodi]', '$_POST[tnohp]', '".date('Y-m-d H:i:s')."', '$_POST[ttglkem]', '$_POST[talamatting]', '$_POST[alamatskr]', '$_POST[tpil1]', '$_POST[tpil2]', '$_POST[tpil3]', '$_POST[tpil4]', '$_POST[tpil5]');";
    ...
    <div class=" mt-4">
      <h2 align="center"><strong>Silahkan lengkapi Form Peminjaman berikut :</strong></h2>
    	<p>&nbsp;</p>
			<?php
			$induk = $_SESSION['pass'];
			$queri2="Select * From user Where nim =$induk" ;  //menampikan data dari induk
   	  ...
   	  <form action="?page=peminjaman" method="post" class="fpad">
    	  <table width="653" border="0">
    	    ...
    	    <tr>
    	      <td></td>
    	      <td></td>
    	      <td><input name="tnohp" type="hidden" value="<?php echo $row['nohp'] ?>" id="tnohp"  class="textbox" /></td>
  	      </tr>
    	    <tr>
    	      <td>Tanggal Peminjaman</td>
    	      <td>:</td>
    	      <td><input name="ttglawal" type="text" disabled="disabled" id="ttglawal" value="<?php echo date('Y / M / d H:i:s') ?>" readonly="readonly" class="textbox"/></td>
  	      </tr>
    	    <tr>
 ...
 <option value="<?=$data['nama']?>"><?=$data['nama']?></option>
	...
	echo "</select>";
		?>
   	    ...
   	    <div class="fpad1">
   	      <input name="simpan" type="submit"  id="simpan" value="Simpan Data" /><? //onClick="window.location='?page=pem-print'" ?>
